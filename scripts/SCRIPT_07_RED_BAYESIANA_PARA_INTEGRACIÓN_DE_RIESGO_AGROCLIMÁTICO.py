...
# Rutas base
BASE_PREV = Path(r"D:\POSGRADOS\TESIS\Prevención_de_Riesgos")
BASE_DATOS = Path(r"D:\POSGRADOS\TESIS\02_DATOS")

# Entradas
VULN_DIR = BASE_PREV / "04_RESULTADOS" / "fase4_modelamiento" / "random_forest" / "proyecciones" / "parroquial"
EXPO_DIR = Path(r"D:\POSGRADOS\TESIS\04_RESULTADOS\exposicion_agricola")
INDICES_DIR = BASE_DATOS / "climaticos" / "indices" / "agregados"
PARROQUIAS_PATH = Path(r"D:\POSGRADOS\TESIS\Imbabura_Parroquia.gpkg")
